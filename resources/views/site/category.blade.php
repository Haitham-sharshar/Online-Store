				...
				<div class="home_content text-center">
					...
					<div class="breadcrumbs d-flex flex-column align-items-center justify-content-center">
						<ul class="d-flex flex-row align-items-start justify-content-start text-center">
							<li><a href="#">Home</a></li>
							<li><a href="category.blade.php">Woman</a></li>
							<li>New Products</li>
						</ul>
					</div>
				</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Cool Clothing with Brown Stripes</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Hype Grey Shirt</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Long Sleeve Jacket</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Denim Men Shirt</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Long Red Shirt</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Short Sleeve Shirt</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Red Stripped Dress</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">White Cotton Shirt</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">Black Short Sleeve Dress</a></div>
											<div class="product_category">In <a href="category.blade.php">Category</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
								<nav class="footer_nav ml-md-auto order-md-2 order-1">
									<ul class="d-flex flex-row align-items-center justify-content-start">
										<li><a href="category.blade.php">Women</a></li>
										<li><a href="category.blade.php">Men</a></li>
										<li><a href="category.blade.php">Kids</a></li>
										<li><a href="category.blade.php">Home Deco</a></li>
