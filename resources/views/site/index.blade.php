											...
											<div class="home_items">
												<div class="row">
													<div class="col-sm-3 offset-lg-1">
														<div class="home_item_side"><a href="product.blade.php"><img src="images/home_1.jpg" alt=""></a></div>
													</div>
													...
													<div class="col-sm-3">
														<div class="home_item_side"><a href="product.blade.php"><img src="images/home_3.jpg" alt=""></a></div>
													</div>
												</div>
											</div>
										</div>
			...
			<div class="container">
					...
					<div class="col">
						<div class="page_nav">
							<ul class="d-flex flex-row align-items-start justify-content-center">
								...
								<li class=""><a href="category.blade.php">{{$category->name}}</a></li>
								@endforeach
							</ul>
						</div>
					</div>
				...
				<div class="row products_row">
					...
					<div class="col-xl-4 col-md-6">
						<div class="product">
							<div class="product_image"><img src="/uploades/{{$product->image}}" height="200px" width="300px" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.blade.php">{{$product->name}}</a></div>
											<div class="product_category">In <a href="category.blade.php">{{$product->category->name}}</a></div>
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
